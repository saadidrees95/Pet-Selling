                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            Sitter Review List
                                            <span class="d-block text-muted pt-2 font-size-sm">Reviews by Sitter</span>
                                        </h3>
                                    </div>
                                        ...
                                        <table class="datatable-table" style="display: block; overflow-x: scroll">
                                            ...
                                            <thead class="datatable-head">
                                                <tr class="datatable-row" style="left: 0px">
                                                    ...
                                                    <th data-field="Sitter" 
                                                        ...
                                                        <span style="width: 250px">Sitter Name</span>
                                                    </th>
                                                    ...
                                                    <th data-field="Species"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 150px">Pet-Owner Name</span>
                                                    </th>
                                                    <th data-field="Species"
                                                        class="datatable-cell datatable-cell-sort">
                                            ...
                                            <tbody style="" class="datatable-body">
                                                ...
                                                <tr data-row="{{ $loop->index }}" class="datatable-row" style="left: 0px">
                                                        ...
                                                        <span style="width: 250px">
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-40 symbol-light-info flex-shrink-0">
                                                                   <div class="symbol symbol-40 symbol-light-info flex-shrink-0">
                                                                    ...
                                                                    @if ($review && $review->sitter->user->userImage)
                                                                        <img src="{{ asset('storage/' . $review->sitter->user->userImage->image_path) }}" alt="Ad Image">
                                                                    @else
                                                                ...
                                                                <div class="ml-4">
                                                                    ...
                                                                    <a href="#"
                                                                        class="text-muted font-weight-bold text-hover-primary">{{$review->sitter->user->email ?? ''}}</a>
                                                                </div>
                                                            </div>
                                                        </span>
                                                    </td>
                                                    ...
                                                    {{-- <a href="{{ route('admin.sitter-review.destroy', ['id' => $review->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2"
                                                        title="Delete"> <span
                                                          ...
                                                          <a href="{{ route('admin.sitter-review.destroy', ['id' => $review->id]) }}" class="btn btn-sm btn-light-danger font-weight-bolder">Delete</a>
                                                </span>
                                            </td>
                                                </tr>
                                            @endforeach
