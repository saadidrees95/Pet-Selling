                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            User List
                                            <span class="d-block text-muted pt-2 font-size-sm">User management made
                                                easy</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        ...
                                        <!--begin::Button-->
                                        <a href="{{route('admin.user.form')}}" class="btn btn-primary font-weight-bolder">
                                            <span
                                            ...
                                            <thead class="datatable-head">
                                                <tr class="datatable-row" style="left: 0px">
                                                    ...
                                                    <th data-field="LongDescription" 
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 130px">Role</span>
                                                    </th>
                                                ...
                                                <!-- table row -->
                                                 <tr data-row="{{ $loop->index }}" class="datatable-row" style="left: 0px">
                                                    <td class="datatable-cell-sorted datatable-cell-left datatable-cell"
                                                     ...
                                                     <td data-field="UserName" aria-label="user-name" class="datatable-cell">
                                                    ...
                                                    <td data-field="Status" aria-label="status"
                                                    ...
                                                    <a href="{{route('admin.user.edit', ['id' => $user->id])}}" class="btn btn-sm btn-default btn-text-primary btn-hover-success btn-icon mr-2"
                                                    ...
                                                    <a href="{{route('admin.user.destroy', ['id' => $user->id])}}" class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2"
                                                        title="Delete"> <span
