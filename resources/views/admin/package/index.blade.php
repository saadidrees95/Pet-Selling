                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            Package List
                                            <span class="d-block text-muted pt-2 font-size-sm">Package management made
                                                easy</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        ...
                                        <!--begin::Button-->
                                        <a href="{{route('admin.package.form')}}" class="btn btn-primary font-weight-bolder">
                                            <span
                                            ...
                                            <thead class="datatable-head">
                                                <tr class="datatable-row" style="left: 0px">
                                                    ...
                                                    <th data-field="ServiceID" 
                                                        ...
                                                        <span style="width: 150px">Package Title</span>
                                                    </th>
                                                    ...
                                                    <th data-field="CreatedOn"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 130px">Created On</span>
                                                    </th>
                                                    <th data-field="LastUpdated"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 130px">Last Update</span>
                                                    </th>
                                            ...
                                            <tbody style="" class="datatable-body">
                                                ...
                                                <tr data-row="{{ $loop->index }}" class="datatable-row" style="left: 0px">
                                                    <td class="datatable-cell-sorted datatable-cell-left datatable-cell"
                                                     ...
                                                     <td data-field="PackageTitle" aria-label="packae-title" class="datatable-cell">
                                                    ...
                                                    <td data-field="CreatedOn" aria-label="created-on"
                                                        ...
                                                        <span style="width: 130px">
                                                            <div class="font-weight-bolder text-muted mb-0">
                                                     ...
                                                     <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                                        ...
                                                        <span
                                                            style="
                                                                            ...
                                                                            width: 130px;
                                                                            ">
                                                    <a href="{{route('admin.package.show', ['id' => $package->id])}}"
                                                    ...
                                                    <a href="{{route('admin.package.edit', ['id' => $package->id])}}" class="btn btn-sm btn-default btn-text-success btn-hover-primary btn-icon mr-2"
                                                    ...
                                                    <a href="{{route('admin.package.destroy', ['id' => $package->id])}}" class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2"
                                                        title="Delete"> <span
