        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container" style="max-width:600px">
                ...
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                   <form class="form" method="POST" action="{{ route('admin.package') }}">
                        @csrf
                        <div class="card-body">
                            {{-- Your form fields --}}
                            <div class="form-group">
                                <label for="name">Title</label>
                                <input type="text" name="name" class="form-control form-control-solid @error('name') is-invalid @else is-valid @enderror" value="{{ old('name') }}" placeholder="Title" required/>
                                 @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="price" class="form-control form-control-solid @error('price') is-invalid @else is-valid @enderror" value="{{ old('price') }}" placeholder="$" required/>
                                 @error('price')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
