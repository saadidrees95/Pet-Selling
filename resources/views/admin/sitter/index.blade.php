                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            Sitter List
                                            <span class="d-block text-muted pt-2 font-size-sm">Sitter management made
                                                easy</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar gap-2">
                                        ...
                                        <!--end::Button-->
                                        <!--begin::Button-->
                                        <a href="{{route('export.sitters')}}" class="btn btn-primary font-weight-bolder">
                                            <span
                                                class="svg-icon svg-icon-md"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Flatten.svg--><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <thead class="datatable-head">
                                                <tr class="datatable-row" style="left: 0px">
                                                    ...
                                                    <th data-field="Sitter"
                                                        ...
                                                        <span style="width: 250px">Sitter</span>
                                                    </th>
                                                    ...
                                                    <th data-field="Species"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 100px">Species</span>
                                                    </th>
                                                    ...
                                                    <th data-field="Register"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 130px">Register On</span>
                                                    </th>
                                                ...
                                                <tr data-row="{{ $loop->index }}" class="datatable-row" style="left: 0px">
                                                        ...
                                                        <span style="width: 250px">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-40 symbol-light-info flex-shrink-0">
                                                                   <div class="symbol symbol-40 symbol-light-info flex-shrink-0">
                                                                    {{-- user profile pic --}}
                                                                    @if ($sitter && $sitter->userImage)
                                                                        <img src="{{ asset('storage/' . $sitter->userImage->image_path) }}" alt="Ad Image">
                                                                    @else
                                                                ...
                                                                <div class="ml-4">
                                                                    ...
                                                                    <a href="#"
                                                                        class="text-muted font-weight-bold text-hover-primary">{{$sitter->email ?? ''}}</a>
                                                                </div>
                                                            </div>
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td data-field="City" aria-label="London" class="datatable-cell">
                                                        <span style="width: 200px">
                                                            ...
                                                            <div class="font-weight-bold text-muted">
                                                            {{$sitter->address->post_code ?? ''}},{{$sitter->address->street ?? ''}}
                                                            </div>
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td data-field="CompanyName" aria-label="Casper-Kerluke"
                                                        ...
                                                        <span style="width: 100px">
                                                            <div class="font-weight-bold text-muted">
                                                                {{$sitter->sitter->petType->species ?? ''}}
                                                            </div>
                                                        </span>
                                                    </td>
                                                    <td data-field="Status" aria-label="5" class="datatable-cell">
                                                        <span style="width: 100px"><span
                                                                class="label label-lg font-weight-bold label-light-info label-inline">{{$sitter->active ?? ''}}</span></span>
                                                    </td>

                                                     <td data-field="ShipDate" aria-label="req_date"
                                                        class="datatable-cell">
                                                        <span style="width: 100px">
                                                            <div class="font-weight-bold text-muted">
                                                               {{$sitter->created_at ?? ''}}
                                                ...
                                                <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                                        ...
                                                        <span
                                                            style="
                                                                            ...
                                                                            width: 130px;
                                                                            ">
                                                    <a href="{{ route('admin.sitter.show', ['id' => $sitter->id]) }}"
                                                    ...
                                                    <a href="{{ route('admin.sitter.edit', ['id' => $sitter->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-success btn-icon mr-2"
                                                    ...
                                                    <a href="{{ route('admin.sitter.destroy', ['id' => $sitter->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2"
                                                        title="Delete"> <span
