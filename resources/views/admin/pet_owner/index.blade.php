                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            Pet Owner List
                                            <span class="d-block text-muted pt-2 font-size-sm">Pet Owner management made
                                                easy</span>
                                        </h3>
                                    </div>
                                    <div class="card-toolbar">
                                        ...
                                        <!--end::Button-->
                                        <!--begin::Button-->
                                        <a href="{{route('export.pet-owners')}}" class="btn btn-primary font-weight-bolder">
                                            <span
                                                class="svg-icon svg-icon-md"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Flatten.svg--><svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                            ...
                                            <thead class="datatable-head">
                                                <tr class="datatable-row" style="left: 0px">
                                                    ...
                                                    <th data-field="UserID"
                                                        ...
                                                        <span style="width: 200px">Pet Owner</span>
                                                    </th>
                                                    <th data-field=Contact"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 130px">Contact</span>
                                                    </th>
                                                    ...
                                                    <th data-field="Pets"
                                                        class="datatable-cell datatable-cell-sort">
                                                        <span style="width: 170px">Pets</span>
                                                    </th>
                                                ...
                                                <tr data-row="{{ $loop->index }}" class="datatable-row" style="left: 0px">
                                                        ...
                                                        <span style="width: 200px">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-40 symbol-light-info flex-shrink-0">
                                                                    {{-- user profile pic --}}
                                                                    @if ($petOwner && $petOwner->userImage)
                                                                        <img src="{{ asset('storage/' . $petOwner->userImage->image_path) }}" alt="Ad Image">
                                                                    @else
                                                                ...
                                                                <div class="ml-4">
                                                                    ...
                                                                    <a href="#"
                                                                        class="text-muted font-weight-bold text-hover-primary">{{$petOwner->email ?? ''}}</a>
                                                                </div>
                                                            </div>
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td data-field="City" aria-label="London" class="datatable-cell">
                                                        <span style="width: 160px">
                                                            ...
                                                            <div class="font-weight-bold text-muted">
                                                                {{$petOwner->address->post_code ?? ''}}, {{$petOwner->address->street ?? ''}}
                                                            </div>
                                                        </span>
                                                    </td>
                                                     <td data-field="Pets Image" aria-label="Pets" class="datatable-cell">
                                                        <span style="width: 170px">
                                                            @if($petOwner->pets)
                                                                @foreach($petOwner->pets as $pet)
                                                                    <img src=" {{ asset('storage/' . $pet->image->image_path)}}" style="border-radius:25px;" with="35" height="35" >
                                                                @endforeach
                                                            @else
                                                                <p>Sorry! you have no Pet!</p>
                                                            @endif
                                                        </span>
                                                    </td>
                                                     <td data-field="Status" aria-label="5" class="datatable-cell">
                                                        <span style="width: 100px"><span
                                                                class="label label-lg font-weight-bold label-light-info label-inline">{{$petOwner->active ?? ''}}</span></span>
                                                    </td>
                                                    ...
                                                    <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                                        ...
                                                        <span
                                                            style="
                                                                            ...
                                                                            width: 130px;
                                                                            ">
                                                    <a href="{{ route('admin.pet-owner.show', ['id' => $petOwner->id]) }}"
                                                     ...
                                                     <a href="{{ route('admin.pet-owner.edit', ['id' => $petOwner->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-success btn-icon mr-2"
                                                    ...
                                                    <a href="{{ route('admin.pet-owner.destroy', ['id' => $petOwner->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2"
                                                        title="Delete"> <span
