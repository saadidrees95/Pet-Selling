                                        ...
                                        <tr data-row="{{ $loop->index }}" class="datatable-row" style="left: 0px">
                                            ...
                                            <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                                ...
                                                <span
                                                    ...
                                                    <a href="{{ route('admin.ad.edit', ['id' => $ad->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-success btn-icon mr-2"
                                                    ...
                                                    <a href="{{ route('admin.ad.delete', ['id' => $ad->id]) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-danger btn-icon mr-2"
                                                        title="Delete"> <span
