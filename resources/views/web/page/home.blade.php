            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="desc">
                        ...
                        <p>Now you can have your little gateway without a worry. Our loving provide services, including taking care of your pets at thier house and at carer's house.</p>
                    </div>
                </div>
                <!-- Services Box -->
                ...
                <div class="col-md-4">
                    <div class="main">
                        ...
                        <div class="title">
                            ...
                            @if($key == 0)
                                <h4><a href="{{ route('drop-and-visit') }}">{{$service->title}}</a></h4>
                            @else
                                <h4><a href="{{ route('house-sitting') }}">{{$service->title}}</a></h4>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="desc">
                        ...
                        <p>We have the luxury of experience and expertise. Our sitters are trained professionals who are great with animals.</p>
                        <ul class="list">
                            <li> <i class="far fa-check-circle"></i>
                                <h4>Customer Focused Reviews</h4>
                                <span> Our customers are happy and satisfied with our service, which makes their pets jump with joy. They come back to us every time.</span>
                            </li>
                            <li> <i class="far fa-check-circle"></i>
                                <h4>We Are Committed</h4>
                                <span>Like you, we love animals. This is why seeing a happy pet is just as important to us as it is to you.
</span>
                            </li>
                            <li> <i class="far fa-check-circle"></i>
                                <h4>Dedicated Team</h4>
                                <span> Our sitters are some of the best in town. Our previous customers say so, and their pets express it. We are best friends with all your pets!
</span>
                            </li>
                        </ul>
                    </div>
