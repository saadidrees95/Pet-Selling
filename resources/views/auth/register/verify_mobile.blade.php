...
<html class="no-js" lang="">
   <head>
      <meta charset="utf-8">
      <title>Mobile Verification - Pet Lodger</title>
            ...
            <div class="row p-0">
               <div class="col-md-7">
                  ...
                  <div class="desc">
                     ...
                     <p>To complete the process please enter the verification code we sent you by SMS</p>
                     <form class="content-area" method="POST" action="{{route('register.verification.mobile')}}">
               ...
               <div class="col-md-5">
                  <div class="pic">
                     <img src="{{asset('assets/image/verifocation-2.png')}}" alt="">
                  </div>
               </div>
            </div>
         </div>
