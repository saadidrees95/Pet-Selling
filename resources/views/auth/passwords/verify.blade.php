            ...
            <div class="row p-0">
               <div class="col-md-7">
                  ...
                  <div class="desc">
                     ...
                     <p>To complete the process please enter the verification code we sent you by email</p>
                     <form class="content-area" method="POST" action="{{route('forgot.verification')}}">
