 ...
 *
 * @author Gastón Heim
 * @author Emerson Carvalho and Updated by nomanahmedkhan.net@gmail.com
 * @version 0.0.2
 *  
 */
...
if (!in_array($laravelVersion, array('4.2', '5.0', '5.1', '5.2', '5.3', '5.4', '5.5', '5.6', '5.7', '5.8', '6.0', '7.0', '8.0', '9.0', '10.0'))) {
...
// Check Laravel 10 requirements
$requirements['filter_enabled'] = extension_loaded("filter");
$requirements['hash_enabled'] = extension_loaded("hash");
    ...
    <div class="wrapper">
        ...
        <form action="?" method="get">
            <select name="v" onchange="this.form.submit()">
                <option value="10.0" <?php echo ($laravelVersion === '10.0') ? 'selected' : '' ?>>Laravel 10.0 - Latest</option>
